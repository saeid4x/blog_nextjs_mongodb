...
console.log(person)
    ...
    let handleDelete = async () =>{
        try{
        let confirmModel = confirm("Are you sure want to delete your blog?")
        if(confirmModel){
    ...
    return (
        <div className={classes.container}>
            <div className={classes.wrapper}>
                <Image src={blogDetails?.photo} alt="blog details page" width='750' height='650'/>
                    ...
                    <h3 className={classes.title}>{blogDetails?.title}</h3>
                    {
                        ...
                        ? ( 
                            <div className={classes.controls}>
                                <Link href={`/blog/edit/${ctx.params.id}`} className={classes.editButton}>
                                    Edit <BsFillPencilFill/>
                                </Link>
                                <button className={classes.deleteButton} onClick={handleDelete}>Delete <AiFillDelete/></button>
                            </div>
                        ):(
                ...
                <div className={classes.commentSection}>
                    ...
                    <div className={classes.commentInput}>
                        <Image src={person} width="45" height='45' alt='dsds' />
                        <input type="text"  placeholder='Type message....' onChange={(e)=> setCommentText(e.target.value)}  value={commentText}/>
                    ...
                    <div className={classes.comments}>
                        {
                            comments?.length > 0 ? (
                                ...
                                <h4 className={classes.noComment}>No Comments. Be the first one to leave a comment!</h4>
                            )
                        }
                    </div>
                </div>
